...
enum EntityType { PLATFORM, PLAYER, ENEMY, HEALTH, PROJECTILE};
...
public:
    ...
    int        const get_direction()      const { return m_current_direction;};
    int        const get_experience()     const { return m_experience;      };
    ...
    void const set_direction(int new_direction)             { m_current_direction = new_direction;  };
    void const set_rotation(float new_rotation)             { m_current_rotation = new_rotation;    };
    void const set_experience(int new_experience)           { m_experience = new_experience;       };
};
